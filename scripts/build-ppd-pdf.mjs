...
const mdPath = path.join(ROOT, 'docs', 'project-purpose-client-revisions-2026-04-21.md')
const outDir = path.join(ROOT, 'docs')
const htmlPath = path.join(outDir, 'project-purpose-client-revisions-2026-04-21.html')
const pdfPath = path.join(outDir, 'project-purpose-client-revisions-2026-04-21.pdf')
...
const css = `
  ...
  * { box-sizing: border-box; }
  ...
  h3 { font-size: 13pt; font-weight: 700; color: var(--navy-800); }
  h4 { font-size: 11pt; font-weight: 700; color: var(--navy-800); }
  p { margin: 0.55em 0; }
...
<section class="cover">
  ...
  <div class="kicker">Website Revisions</div>
  <h1>Plan &amp; Summary</h1>
  <p class="sub">Site-wide revisions for Friends of Jenny Kamprath — Washington County Chair campaign website.</p>
  <dl class="meta">
    <dt>Project</dt><dd>Friends of Jenny Kamprath</dd>
    <dt>Date Received</dt><dd>2026-04-21</dd>
  </dl>
</section>
`
...
<head>
  <meta charset="utf-8" />
  <title>Project Purpose — Client Revisions — 2026-04-21</title>
...
console.log('Running:', chromeExe, args.join(' '))
